...
### Ausgangslage
In den vorliegenden Inhalten ging es um die Frage, wie gut Shader – insbesondere der „Complementary Reimagined“-Shader in Minecraft – auf unterschiedlichen Grafikkarten laufen. Dabei wurden sowohl die Hardware von „Einfach-Emmy“ als auch die eigene verglichen.
...
Hinweis: Die genannten Zahlen orientieren sich an der referenzierten Wiki‑Seite und dem vorliegenden Abgleich. Mojang kann Werte in zukünftigen Versionen ändern; bei Abweichungen bitte das offizielle Changelog bzw. die aktualisierte Wiki‑Tabelle prüfen.
...
- 46 → 1.21.0 Pre 1–4 und als Release‑Wert für 1.21.4 Ressourcenpacks (maßgeblich für das jeweilige Setup).
...
- Der Server läuft auf 1.21.4 – maßgeblich ist daher der Ressourcenpack‑Wert 46 (siehe Mapping unten). Wird ein höherer Snapshot/Datapack‑Wert eingetragen, meckert der Client.
...
- Betroffene Packs (z. B. Sandy Dunes, XP‑Bar) auf pack_format: 46 umstellen.
...
### Überblick
In den vorliegenden Inhalten habe ich mich intensiv mit dem Minecraft-Datapack Roguecraft sowie der Modpack-Erweiterung Roguecraft Evolved beschäftigt. Wir haben Gemeinsamkeiten, Unterschiede, technische Details und meine persönlichen Gedanken über mögliche Anpassungen diskutiert.
...
Fazit:
Minecraft ist durch alte Rendering-Technik grundsätzlich instabil. Mit Iris + Sodium + Mods wie Continuity und FerriteCore wird es aber performant und modernisiert. Shader wie Astralex und Rethinking Voxels ergänzen sich: Alltag vs. Showcase. Perfektionismus kann so kanalisiert werden, indem man zwei Shader-Profile nutzt. Kotlin setzt sich im Modding durch und wird Java teilweise ablösen. Die vorliegende Modliste ist nahezu ideal abgestimmt.
